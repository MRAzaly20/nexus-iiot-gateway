...
class ProcessedDataBatchCreate(ProcessedDataBatchBase):
    data_points: List[DataPointCreate] = []  # Tambahkan data points untuk create

class ProcessedDataBatchUpdate(BaseModel):
...
class BufferedDataEntryUpdate(BufferedDataEntryBase):
    destination: Optional[str] = None
    payload: Optional[str] = None
    timestamp_queued: Optional[datetime] = None
    status: Optional[str] = None
