...
/*****************************************************************************/
/*! \file       iec104servertest.py
 *  \brief      Python Source code file, IEC 60870-5-104 Server library test program
 *
...
def main():
    ...
    while(True):
        ...
        if i16ErrorCode != 0:
            ...
            message = f"IEC 60870-5-104 Library API Function - IEC104IEC104LoadConfiguration() success"
            print(message) 
