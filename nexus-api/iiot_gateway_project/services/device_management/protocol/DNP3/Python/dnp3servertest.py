...
def main():
    ...
    if i16ErrorCode.value != 0:
        ...
        message = f"DNP3 Library API Function - DNP3Create() success"
        print(message) 
    ...
    while(True):
        ...
        if i16ErrorCode != 0:
            ...
            message = f"DNP3 Library API Function - DNP3IEC104LoadConfiguration() success"
            print(message) 
        ...
        if i16ErrorCode != 0:
            ...
            message = f"DNP3 Library API Function - DNP3Start() success"
            print(message) 
    ...
    if i16ErrorCode != 0:
        ...
        message = f"DNP3 Library API Function - DNP3Stop() success"
        print(message) 
    ...
    if i16ErrorCode != 0:
        ...
        message = f"DNP3 Library API Function - DNP3Free() success"
        print(message) 
